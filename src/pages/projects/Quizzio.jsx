...
export default function Quizzio() {
  ...
  return (
    <main className="bg-black text-white px-6 md:px-12 lg:px-16 pt-24 md:pt-32 pb-40">
      ...
      <p className="max-w-2xl text-white/70 text-lg leading-relaxed mb-4">
        An AI-powered career platform featuring mock interviews, resume building, 
        job applications, skill assessments, and personalized career tools.
      </p>

      <p className="max-w-2xl text-white/50 text-base leading-relaxed">
        Combines interactive quizzes, AI-driven interview feedback, resume generation, 
        and career resources into a single ecosystem. Built with React, Spring Boot, 
        Java, MySQL, JWT, REST API, AI APIs, and Tailwind CSS. Enables users to assess 
        their skills, improve interview performance, build professional resumes, and 
        streamline their job search.
      </p>
