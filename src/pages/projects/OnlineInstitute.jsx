...
export default function OnlineInstitute() {
  ...
  return (
    <main className="bg-black text-white px-6 md:px-12 lg:px-16 pt-24 md:pt-32 pb-40">
      ...
      <p className="max-w-2xl text-white/70 text-lg leading-relaxed mb-4">
        A full-stack educational management platform for online admissions, 
        course management, and institute administration with a secure admin dashboard.
      </p>

      <p className="max-w-2xl text-white/50 text-base leading-relaxed">
        Developed for <strong>Udhayan Institute</strong>, featuring online admissions, 
        course and semester management, dynamic enrollment forms, secure authentication, 
        and a comprehensive admin dashboard. Built with React, Node.js, Express, MongoDB, 
        Tailwind CSS, Cloudinary, and JWT authentication.
      </p>
